			...
			<div className='grid md:grid-cols-[1.4fr,1fr] gap-0'>
				...
				<div className='p-8 md:p-10 flex flex-col justify-center'>
					...
					<div className='flex flex-wrap items-center gap-3 mb-8'>
						...
						<Link
							to='/'
							className='inline-flex items-center justify-center px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-600 text-white text-sm font-semibold shadow-lg shadow-blue-500/30 hover:from-blue-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-900 transition'
						>
							Go to Dashboard
							<ArrowRight className='w-4 h-4 ml-2' />
						</Link>
